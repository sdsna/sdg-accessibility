...
directory = os.chdir(r'/Users/guilhermeiablonovski/Dropbox (SDSN)/SDG Geospatial Indicators Project/sdg-accessibility')

# download POIs at https://github.com/MorbZ/OsmPoisPbf/ and filter using uac_filter.txt
# java -jar osmpois.jar --filterFile uac_filter.txt --printHeader asia-latest.osm.pbf

df = pd.read_csv("data/input/asia-latest.csv", sep='|')
df = df[df.category.astype(str).str.isnumeric()==True]
...
#r_cities.to_csv('data/cities_processed.csv')
